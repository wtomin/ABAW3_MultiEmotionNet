...
parser.add_argument("--txt_file", type=str, default='/media/Samsung/ABAW3_Challenge/CVPR_2022_3rd_ABAW_Competition _Test_Set_Release_&_Submission_Instructions/Expression_Classification_Challenge_test_set_release.txt')
